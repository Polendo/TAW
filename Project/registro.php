<?php
  ...
  if (!empty($_POST['nombre']) && !empty($_POST['password']) && !empty($_POST['email']) 
    ...
    $sql = "INSERT INTO users (name, password, email, country, state, city, address, card, post_code) VALUES (:nombre, :password, :email, :pais, :estado, :ciudad, :direccion, :numTarjeta, :cp)";
